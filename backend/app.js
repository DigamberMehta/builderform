...
const allowedOrigins = [
  ...
  "https://builderfor-mqn5.vercel.app",
];
...
const builderSchema = new mongoose.Schema(
  {
    ...
    english_level: {
      ...
      enum: [
        "none",
        "can_understand_a_bit",
        "can_understand_most",
        "can_understand_most_and_speak",
        "fluent",
      ],
      default: "none",
    },
    alcohol: {
      ...
      enum: [
        "none",
        "yes_but_not_during_work",
        "yes_and_also_during_work",
        "i_have_a_drinking_problem_and_it_could_affect_my_work",
      ],
      default: "none",
    },
...
app.post("/api/submit-builder-form", async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({
        message: "Builder application submitted successfully!",
        builder: newBuilder,
      });
  } catch (err) {
